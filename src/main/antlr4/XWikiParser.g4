...
ordered_list: ID+ CHAR_DOT content ;
...
image: OPEN_DSQBRACE LINKTEXT_IMAGE internal_link_ref CLOSE_DSQBRACE ;
...
internal_link_ref: (LINKID |  LINKCHARACTER | LINKSPACE )+;
...
bold: CHAR_STAR CHAR_STAR plain CHAR_STAR CHAR_STAR;
italic: ITALIC plain ITALIC;

/* Plain text */
plain: (ID | STRING | CHARACTER | CHAR_DOT | SPACE)+;
